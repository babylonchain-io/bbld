...
[![GoDoc](https://img.shields.io/badge/godoc-reference-blue.svg)](https://pkg.go.dev/github.com/babylon-chain/bbld/peer)
...
```bash
$ go get -u github.com/babylon-chain/bbld/peer
```

## Examples

* [New Outbound Peer Example](https://pkg.go.dev/github.com/babylon-chain/bbld/peer#example-package--NewOutboundPeer)  
