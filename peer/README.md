...
[![GoDoc](https://img.shields.io/badge/godoc-reference-blue.svg)](https://pkg.go.dev/github.com/babylonchain-io/bbld/peer)
...
```bash
$ go get -u github.com/babylonchain-io/bbld/peer
```

## Examples

* [New Outbound Peer Example](https://pkg.go.dev/github.com/babylonchain-io/bbld/peer#example-package--NewOutboundPeer)  
