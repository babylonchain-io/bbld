...
[![GoDoc](https://img.shields.io/badge/godoc-reference-blue.svg)](https://pkg.go.dev/github.com/KonradStaniec/test-node/peer)
...
```bash
$ go get -u github.com/KonradStaniec/test-node/peer
```

## Examples

* [New Outbound Peer Example](https://pkg.go.dev/github.com/KonradStaniec/test-node/peer#example-package--NewOutboundPeer)  
