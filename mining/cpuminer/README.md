...
[![GoDoc](https://img.shields.io/badge/godoc-reference-blue.svg)](https://pkg.go.dev/github.com/babylon-chain/bbld/mining/cpuminer)
=======
...
```bash
$ go get -u github.com/babylon-chain/bbld/mining/cpuminer
```
