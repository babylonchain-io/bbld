...
For example (taken from [f3ec130](https://github.com/babylon-chain/bbld/commit/f3ec13030e4e828869954472cbc51ac36bee5c1d)):
```diff
...
1. `git clone https://github.com/babylon-chain/bbld.git`
2. `cd btcd`
...
which roughly follow the format of [previous release notes](https://github.com/babylon-chain/bbld/releases/tag/v0.20.1-beta).
...
6. Obtain a copy of `btcd`'s source code with `git clone
   https://github.com/babylon-chain/bbld` and checkout the source code of the
