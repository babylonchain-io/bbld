	...
	tests := []struct {
		...
		// claims to have ~uint64(0) length.
		{
			[]byte{
				...
				0xff, 0xff, 0xff, 0xff, // Little endian previous output index
				0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff,
		...
		// that claims to have ~uint64(0) length.
		{
			[]byte{
				...
				0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, // Output amount
				0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff,
...
var multiWitnessTxEncoded = []byte{
	...
	0x16, // Varint for length of public key script
