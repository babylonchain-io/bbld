...
func TestInvWireErrors(t *testing.T) {
	...
	tests := []struct {
		...
		{baseInv, baseInvEncoded, pver, WitnessEncoding, 0, io.ErrShortWrite, io.EOF},
		// Force error in inventory list.
		{baseInv, baseInvEncoded, pver, WitnessEncoding, 1, io.ErrShortWrite, io.EOF},
		// Force error with greater than max inventory vectors.
		{maxInv, maxInvEncoded, pver, WitnessEncoding, 3, wireErr, wireErr},
	}
