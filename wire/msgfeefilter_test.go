...
func TestFeeFilterLatest(t *testing.T) {
	...
	err := msg.BtcEncode(&buf, pver, WitnessEncoding)
	if err != nil {
	...
	err = readmsg.BtcDecode(&buf, pver, WitnessEncoding)
	if err != nil {
...
func TestFeeFilterWire(t *testing.T) {
	...
	for i, test := range tests {
		...
		var buf bytes.Buffer
		err := test.in.BtcEncode(&buf, test.pver, WitnessEncoding)
		if err != nil {
		...
		err = msg.BtcDecode(rbuf, test.pver, WitnessEncoding)
		if err != nil {
...
func TestFeeFilterWireErrors(t *testing.T) {
	...
	for i, test := range tests {
		...
		err := test.in.BtcEncode(w, test.pver, WitnessEncoding)
		...
		err = msg.BtcDecode(r, test.pver, WitnessEncoding)
