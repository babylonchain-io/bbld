...
[![GoDoc](https://pkg.go.dev/github.com/KonradStaniec/test-node/database/ffldb?status.png)](https://pkg.go.dev/github.com/KonradStaniec/test-node/database/ffldb)
=======
