...
[![GoDoc](http://img.shields.io/badge/godoc-reference-blue.svg)](http://godoc.org/github.com/KonradStaniec/test-node/btcutil/txsort)
...
```bash
$ go get -u github.com/KonradStaniec/test-node/btcutil/txsort
```
