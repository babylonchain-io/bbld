...
commits](https://github.com/KonradStaniec/test-node/commits/master) for examples of
commit messages.
...
Rejoice as you will now be listed as a [contributor](https://github.com/KonradStaniec/test-node/graphs/contributors)!
...
[ISC license](https://github.com/KonradStaniec/test-node/blob/master/LICENSE).  This is
