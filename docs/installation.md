...
* Install the MSI available at: [btcd windows installer](https://github.com/babylon-chain/bbld/releases)
...
```bash
git clone https://github.com/babylon-chain/bbld $GOPATH/src/github.com/babylon-chain/bbld
...
* [Using bootstrap.dat](https://github.com/babylon-chain/bbld/blob/master/docs/configuration.md#using-bootstrapdat)
