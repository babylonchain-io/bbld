...
[![GoDoc](https://img.shields.io/badge/godoc-reference-blue.svg)](https://pkg.go.dev/github.com/KonradStaniec/test-node/chaincfg)
...
```bash
$ go get -u github.com/KonradStaniec/test-node/chaincfg
```
